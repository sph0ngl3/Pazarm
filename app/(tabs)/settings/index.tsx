...
import { User, Bell, Lock, LogOut, Plus, ChevronRight, Map as MapIcon, Info, Coins, Calendar, ShoppingBag, Truck, Handshake } from 'lucide-react-native';
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={[styles.content, { paddingBottom: 80 }]}>
        ...
        {/* Activity Section (Moved to Bottom) */}
        <View style={styles.section}>
          <Text style={styles.sectionHeader}>Geçmiş İşlemler</Text>
          <View style={styles.cardGroup}>
             <View style={styles.activityRow}>
                <View style={[styles.iconBox, { backgroundColor: '#F0FDF4' }]}>
                   <ShoppingBag size={18} color={COLORS.freshGreen} />
                </View>
                <View style={styles.activityContent}>
                   <Text style={styles.activityTitle}>Sipariş Teslim Edildi</Text>
                   <Text style={styles.activityDate}>12 Ekim 2025</Text>
                </View>
                <Text style={styles.activityValue}>-350 TL</Text>
             </View>
             ...
             <View style={styles.activityRow}>
                ...
                <View style={styles.activityContent}>
                   <Text style={styles.activityTitle}>M Puan Kazanıldı</Text>
                   <Text style={styles.activityDate}>12 Ekim 2025</Text>
                </View>
                <Text style={[styles.activityValue, { color: COLORS.warning }]}>+12</Text>
             </View>

             <View style={[styles.activityRow, { borderBottomWidth: 0 }]}>
                <View style={[styles.iconBox, { backgroundColor: '#EFF6FF' }]}>
                   <Calendar size={18} color={COLORS.deepBlue} />
                </View>
                <View style={styles.activityContent}>
                   <Text style={styles.activityTitle}>Abonelik Yenilendi</Text>
                   <Text style={styles.activityDate}>10 Ekim 2025</Text>
                </View>
                <Text style={styles.activityValue}>Meyve Paketi</Text>
             </View>
          </View>
        </View>
